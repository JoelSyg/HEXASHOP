...
@Component({
  ...
  standalone: true,
  imports: [HeaderComponent, FooterComponent, RouterModule, HeroSectionComponent, LatestClothingComponent, ProductsSectionComponent, SocialMediaSectionComponent],
